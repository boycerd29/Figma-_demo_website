...
const Home = () => {
    ...
    return (
      <div className= 'hero overflow-hidden p-[35px] mt-[150px] md:mt-[200px] w-full flex flex-col md:gap-10 items-center justify-center'>
        <h1
        data-aos="fade-down" 
        data-aos-delay="200"
        data-aos-easing="linear"
        data-aos-duration='500'
        className='heroH text-center md:w-[709px] h-[186] md:h-[196px] lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] leading-[62px] md:leading-[88px] translate-[0.2px]
        md:font-bold'
        
        >
         Work at the speed of thought</h1>
         <p
         data-aos='fade-down' 
         data-aos-duration='500'
         data-aos-delay="600"
         ...
         className="heroS mt-[10px] text-center md:mt-3 text-[20px] sm:w-[382px] sm:h-[120px] flex items-center leading-[30px] tracking-[0.2px] md:w-[700px] md:h-[60px] p-[20px] md:pl-[60px]">Most calendars are designed for teams. Slate is designed for 
          freelancer who want a simple way to plan their schedule
         </p>
         <div 
      data-aos="fade-down" 
      data-aos-delay="1000"
